...
namespace Harp.LoadCells
{
    ...
    /// <summary>
    /// Represents an operator that writes the sequence of <see cref="LoadCells"/>" messages
    /// to the standard Harp storage format.
    /// </summary>
    [DefaultProperty(nameof(Path))]
    [Description("Writes the sequence of LoadCells messages to the standard Harp storage format.")]
    public partial class DeviceDataWriter : Sink<HarpMessage>, INamedElement
    {
        ...
        string INamedElement.Name => nameof(LoadCells) + "DataWriter";
        ...
        public string Path
        {
            ...
            set => writer.FileName = System.IO.Path.Combine(value, nameof(LoadCells) + BinaryExtension);
        }
    ...
    public partial class AcquisitionState
    {
        ...
        public static Timestamped<EnableFlag> GetTimestampedPayload(HarpMessage message)
        {
            ...
            return Timestamped.Create((EnableFlag)payload, timestamp);
        }
    ...
    public partial class DigitalInputState
    {
        ...
        {
            var (payload, timestamp) = message.GetTimestampedPayloadByte();
            return Timestamped.Create((DigitalInputs)payload, timestamp);
        }
    ...
    public partial class SyncOutputState
    {
        ...
        {
            var (payload, timestamp) = message.GetTimestampedPayloadByte();
            return Timestamped.Create((SyncOutputs)payload, timestamp);
        }
    ...
    public partial class DI0Trigger
    {
        ...
        {
            var (payload, timestamp) = message.GetTimestampedPayloadByte();
            return Timestamped.Create((TriggerConfig)payload, timestamp);
        }
    ...
    public partial class DO0Sync
    {
        ...
        {
            var (payload, timestamp) = message.GetTimestampedPayloadByte();
            return Timestamped.Create((SyncConfig)payload, timestamp);
        }
    ...
    public partial class DigitalOutputSet
    {
        ...
        public static Timestamped<DigitalOutputs> GetTimestampedPayload(HarpMessage message)
        {
            ...
            return Timestamped.Create((DigitalOutputs)payload, timestamp);
        }
    ...
    public partial class DO1TargetLoadCell
    {
        ...
        {
            var (payload, timestamp) = message.GetTimestampedPayloadByte();
            return Timestamped.Create((LoadCellChannel)payload, timestamp);
        }
    ...
    public partial class EnableEvents
    {
        ...
        {
            var (payload, timestamp) = message.GetTimestampedPayloadByte();
            return Timestamped.Create((LoadCellEvents)payload, timestamp);
        }
